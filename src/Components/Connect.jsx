...
function Connect() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Create a new FormData object and append all form fields along with the access key
    ...
    return (
        <div className="bg-white py-4">
            <div className="container mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Left Side */}
                <div className="bg-white ml-6 rounded-lg p-8">
                    <h2 className="text-3xl font-bold mb-6 text-blue-900">Get in Touch</h2>

                    {/* Address Section */}
                    <div className="mb-6 flex items-center space-x-3">
                        <img src={home} alt="Address" className="w-8 h-8" />
                    ...
                    <div>
                        ...
                        <div className="flex space-x-6">
                            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform duration-300">
                                <img src={tx} alt="Twitter" className="w-8 h-8" />
                            </a>
                ...
                <div className="bg-white mr-20 rounded-lg p-8">
